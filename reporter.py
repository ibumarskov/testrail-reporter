...
from lib.testlistparser import TestListParser
...
def publish(args):
    ...
    # reporter.report_test_plan(args.tr_plan, args.tr_suite, args.tr_run,
...
def update_suite(args):
    ...
    tc_parser = TestListParser(case_map=args.testcase_map)
...
def main():
    ...
    parser_c.add_argument(
        ...
        default='etc/maps/pytest/name_template.yaml',
        help='TestCase map'
    )
